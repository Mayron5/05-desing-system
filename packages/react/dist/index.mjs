...
function Checkbox2(props) {
  return /* @__PURE__ */ jsx2(CheckboxContainer, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx2(CheckboxIndicator, { asChild: true, children: /* @__PURE__ */ jsx2(Check, { width: "bold" }) }) }));
}
  ...
  return /* @__PURE__ */ jsxs2(MultiStepContainer, { children: [
    /* @__PURE__ */ jsx3(
      Steps,
      {
        ...
        children: Array.from({ length: size }, (_, i) => i + 1).map((step) => /* @__PURE__ */ jsx3(Step, { active: currentStep >= step, children: step }, step))
      }
    ),
